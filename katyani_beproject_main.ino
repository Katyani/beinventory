...
// Fingerprint for URL, needs to be updated well before this date
...
const char* ssid = "vivo1920";   // your network SSID (name) 
...
String data2;
const String data1 = "https://script.google.com/macros/s/AKfycbwK_mezAium8aVUIR7SHJz7qRoRpz6Z5T49-YbSbBH2zPOFab9K2eWo5X-KFeb0cEA/exec?name=";
...
void setup() 
{
  ...
  //WiFiMulti.addAP("vivo1920", "12345678");
